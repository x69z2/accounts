...
os.system("clear")
bnar = pyfiglet.figlet_format('JABAL')
yso = ('                                WELCOME,JUST WAIT')
print (bnar+yso)
...
# = = = = = = = = = = = =
webbrowser.open('https://t.me/x69z2')

print('\n')

ID = input(Z+'Enter Your ID:  ')
print('\n')
sleep(2)
token = input(Z+'Enter Your Token:    ')
